...
<template>
    <div
        class="pb-device-container p-8 min-h-full relative select-none"
                                ...
                                <a-dropdown trigger="hover" :popup-max-height="false">
                                    ...
                                    <template #content>
                                        <DeviceActionDisconnect
                                            v-if="
                                                r.type === EnumDeviceType.WIFI &&
                                                r.status === EnumDeviceStatus.CONNECTED
                                            "
                                            :device="r"
                                        />
                                        <DeviceActionConnect
                                            v-if="
                                                r.type === EnumDeviceType.WIFI &&
                                                r.status === EnumDeviceStatus.DISCONNECTED
                                            "
                                            :device="r"
                                        />
                                        ...
                                        <a-doption
                                            v-if="r.status === EnumDeviceStatus.DISCONNECTED"
                                            @click="doDelete(r)"
                                        >
                                            {{ $t("删除设备") }}
                                        </a-doption>
