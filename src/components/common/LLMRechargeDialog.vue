    ...
    <a-modal v-model:visible="visible" width="min(460px, 90vw)" :footer="false" title-align="start">
        ...
        >
            ...
            <div class="relative text-center">
                ...
                >
                    <icon-exclamation-circle class="text-4xl" aria-hidden="true" />
                </div>
                <div class="mb-2 text-xl font-bold text-gray-900">{{ $t('error.energyInsufficient') }}</div>
                ...
                <div class="flex items-center justify-center gap-3">
                    ...
                    <a-button
                        type="primary"
                        class="min-w-28 shadow-lg shadow-[rgb(var(--primary-3))]"
                        @click="doRecharge"
                    >
                        <template #icon><icon-exclamation-circle aria-hidden="true" /></template>
                        {{ $t('common.recharge') }}
                    </a-button>
                </div>
            </div>
